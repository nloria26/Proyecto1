...
package Vehiculo;
import ControlKilometraje.ControlKilometraje;
...
public class Vehiculo {
    private ControlKilometraje ControlKilo;
    private Motor motor;
    ...
    public Vehiculo() {
        this.ControlKilo = new ControlKilometraje(0,50,1,sistemaFrenos);
    ...
    public ControlKilometraje getControlKilo() {
        return ControlKilo;
    }
